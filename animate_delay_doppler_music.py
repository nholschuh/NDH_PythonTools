...
def animate_delay_doppler_music(videoname,radar_data,depth_data,music_data1,doppler_data2,frame_skip,ymax=0,max_amp=0,min_amp=0):
    """
    ...
    theta_min = np.min([theta_deg2[0]])
    theta_max = np.max([theta_deg2[-1]])  
